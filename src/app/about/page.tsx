    ...
    <>
      <div className="text-center" >
        ...
        <h6 className="p-2 m-2" style={{ color: "#472401E5" }}>
          ...
          By directly connecting farmers with consumers and businesses, we cut out middlemen to deliver produce that is fresher, safer, and more affordable.
        ...
        <div className="row pt-2 align-items-center">
          ...
          <div className="col-md-6">
            <p className="p-2 pt-4" style={{ color: "#553500", marginTop: "20px" }}>
              ...
              Our focus is not just on delivering fruits and vegetables, but on nurturing trust, reducing waste, and creating value across the ecosystem.
              <br /><br />
              At Desimati, we believe that freshness is not a privilege—it’s a promise.
            </p>
          </div>
        </div>
